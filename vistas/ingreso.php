            ...
            <div class="row">
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <!--Fin centro -->
                    <div id="formularioregistros" class="panel-body" style="min-height: 400px;">
                        ...
                        <input class="form-control" type="text" name="impuesto" id="impuesto" maxLength="10" placeholder="Impuesto" required>
                        </div>
                        ...
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          ...
                          <button id="btnCancelar" class="btn btn-danger" onclick="cancelarForm()"><i class="fa fa-arrow-circle-left"> Cancelar</i></button>
                        </div>
