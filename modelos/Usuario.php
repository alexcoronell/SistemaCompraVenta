...
Class Usuario {
    ...
    // Implementamos métodos para insertar registros
    ...
    public function editar($idusuario, $nombre, $tipo_documento, $num_documento, $direccion, $telefono, $email, $cargo, $login, $clave, $imagen, $permisos) {
        ...
        // Eliminamos todos los permisos que tenga asignados y los volvemos a registrar
    ...
    // Implementamos un método para desactivar artículos
    ...
    // Implementamos un método para activar artículos
